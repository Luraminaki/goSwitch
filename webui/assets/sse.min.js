/*
 * Vendored from https://github.com/bigskysoftware/htmx-extensions (src/sse/sse.js),
 * the official SSE extension for htmx, self-hosted so this project never fetches JS
 * from a third-party CDN at runtime.
 * License: none declared upstream as of vendoring (no LICENSE file or package.json
 * "license" field in that repo). Same org/author as htmx core, which is 0BSD, and
 * htmx.org's own docs link to this extension for self-hosting -- but note this is
 * not a confirmed license grant, just a reasonable-confidence assumption.
 */
